...
| Domain | Technologies |
| :--- | :--- |
| **AI / Machine Learning** | PyTorch, HuggingFace, MedGemma-27b, Quantization (4-bit/8-bit), NLP, NER |
| **Data Engineering** | Vectorized Python (NumPy, Pandas), Relational Modeling, Synthetic Data Gen |
| **Full-Stack Development** | Next.js, Vite, Node.js, Premium Vanilla CSS/Tailwind, PostgreSQL |
| **Cloud & Infrastructure** | GCP, NVIDIA L4/A100 Compute, Linux/Shell, Git Ops |
